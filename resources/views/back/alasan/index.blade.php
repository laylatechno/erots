                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_alasan" name="nama_alasan"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_alasan_edit" name="nama_alasan"
                                                placeholder="Masukkan Nama Alasan" required>
                                        </div>
                                    </div>
            ...
            $('#example1').on('click', '.btn-edit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#kategori_alasan_id_edit').val(data.kategori_alasan_id);
                        $('#nama_alasan_edit').val(data.nama_alasan);
