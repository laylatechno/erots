                        ...
                        <tbody>
                            ...
                            @foreach ($informasi as $p)
                                <tr>
                                    ...
                                    <td><a href="/upload/informasi/{{ $p->gambar }}" target="_blank"><img
                                                style="max-width:100px; max-height:100px"
                                                src="/upload/informasi/{{ $p->gambar }}" alt=""></a></td>
                                    <td>{{ $p->status }}</td>
                                    <td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_informasi"
                                                name="nama_informasi" placeholder="Masukkan Nama Informasi" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_informasi_edit"
                                                name="nama_informasi" placeholder="Masukkan Nama Informasi" required>
                                        </div>
                                    </div>
            ...
            $('#example1').on('click', '.btn-edit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#kategori_informasi_id_edit').val(data.kategori_informasi_id);
                        ...
                        if (data.gambar) {
                            var gambarImg = '<img src="/upload/informasi/' + data.gambar +
                                '" style="max-width: 200px; max-height: 200px;">';
                            var gambarLink = '<a href="/upload/informasi/' + data.gambar +
