                        ...
                        <form id="form-tambah" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group" id="nama_kategori_berita_container">
                                            <label for="name">Nama Kategori</label>
                                            <input type="text" class="form-control" name="nama_kategori_berita" id="nama_kategori_berita"
                        ...
                        <form id="form-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group" id="nama_kategori_berita_edit_container">
                                            <label for="name">Nama Kategori</label>
                                            <input type="text" class="form-control" name="nama_kategori_berita" id="nama_kategori_berita_edit"
                                                placeholder="Nama Kategori Berita">
                                        </div>
                                    </div>
                                    <div class="col-12">
    ...
    <script>
        $(document).ready(function() {
            $('#form-tambah').submit(function(event) {
                ...
                $.ajax({
                    url: '{{ route('kategori_berita.store') }}',
                    type: 'POST',
                    data: formData,
