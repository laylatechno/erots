                        ...
                        <tbody>
                            ...
                            @foreach ($kurir as $p)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($p->tanggal_lahir)->translatedFormat('l, d F Y') }}</td>

                                    <td>{{ \Carbon\Carbon::parse($p->tanggal_lahir)->age }} tahun</td>
                                    <!-- Menghitung umur -->
                                    <td>{{ $p->afiliasi }}</td>
                                    <td>{{ $p->no_wa }}</td>
                                    <td>
                                        <a href="/upload/kurir/{{ $p->gambar }}" target="_blank">
                                            <img style="max-width:100px; max-height:100px"
                                                src="/upload/kurir/{{ $p->gambar }}" alt="">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="afiliasi" name="afiliasi"
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="gambar">Gambar Kurir</label>
                        ...
                        <form id="form-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="nama_kurir_edit">Nama Kurir</label>
                                            <input type="text" class="form-control" id="nama_kurir_edit"
                                                name="nama_kurir" placeholder="Masukkan Nama Kurir" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tempat_lahir_edit"
                                                name="tempat_lahir" placeholder="Masukkan Tempat Lahir" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="no_wa_edit" name="no_wa"
                                                placeholder="Masukkan No WA" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="afiliasi_edit">Afiliasi</label>
                                            <input type="text" class="form-control" id="afiliasi_edit"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="deskripsi_edit"
            ...
            $('#example1').on('click', '.btn-edit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#nama_kurir_edit').val(data.nama_kurir);
