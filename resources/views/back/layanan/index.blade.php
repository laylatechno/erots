                        ...
                        <tbody>
                            ...
                            @foreach ($layanan as $p)
                                <tr>
                                    ...
                                    <td><a href="/upload/layanan/{{ $p->gambar }}" target="_blank"><img
                                                style="max-width:100px; max-height:100px"
                                                src="/upload/layanan/{{ $p->gambar }}" alt=""></a></td>
                                    <td>
                        ...
                        <form id="form-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="nama_layanan_edit">Nama Layanan</label>
                                            <input type="text" class="form-control" id="nama_layanan_edit" name="nama_layanan"
                                                placeholder="Masukkan Nama Layanan" required>
                                        </div>
                                    </div>
...
@push('scripts')
            ...
            $('#example1').on('click', '.btn-edit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#kategori_layanan_id_edit').val(data.kategori_layanan_id);
                        ...
                        if (data.gambar) {
                            var gambarImg = '<img src="/upload/layanan/' + data.gambar +
                                '" style="max-width: 200px; max-height: 200px;">';
                            var gambarLink = '<a href="/upload/layanan/' + data.gambar +
    ...
    <script>
        $(document).ready(function() {
            $('#example tbody').on('click', 'td .btn-hapus', function(e) {
                e.preventDefault();
                var id = $(this).data('id');
