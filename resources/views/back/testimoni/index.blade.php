                        ...
                        <tbody>
                            ...
                            @foreach ($testimoni as $p)
                                <tr>
                                    ...
                                    <td><a href="/upload/testimoni/{{ $p->gambar }}" target="_blank"><img
                                                style="max-width:100px; max-height:100px"
                                                src="/upload/testimoni/{{ $p->gambar }}" alt=""></a></td>
                                    <td>
                        ...
                        <form id="form-tambah" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_testimoni" name="nama_testimoni"
                                                placeholder="Masukkan Nama Testimoni" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="gambar">Gambar Testimoni</label>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="status">Status <span>(misal: Dokter/Guru)</span></label>
                        ...
                        <form id="form-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="nama_testimoni_edit">Nama Testimoni</label>
                                            <input type="text" class="form-control" id="nama_testimoni_edit" name="nama_testimoni"
                                                placeholder="Masukkan Nama Testimoni" required>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('.btn-edit').click(function(e) {
                ...
                $.ajax({
                    method: 'GET',
                    url: '/testimoni/' + id + '/edit',
                    success: function(data) {
                        // Mengisi data pada form modal
                        $('#id').val(data.id) // Menambahkan nilai id ke input tersembunyi
                        $('#kategori_testimoni_id_edit').val(data.kategori_testimoni_id);
                        $('#nama_testimoni_edit').val(data.nama_testimoni);
                        ...
                        if (data.gambar) {
                            var gambarImg = '<img src="/upload/testimoni/' + data.gambar +
                                '" style="max-width: 200px; max-height: 200px;">';
                            var gambarStatus = '<a href="/upload/testimoni/' + data.gambar +
