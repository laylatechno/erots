                        ...
                        <tbody>
                            ...
                            @foreach ($video as $p)
                                <tr>
                                    ...
                                    <td><a href="/upload/video/{{ $p->gambar }}" target="_blank"><img
                                                style="max-width:100px; max-height:100px"
                                                src="/upload/video/{{ $p->gambar }}" alt=""></a></td>
                                    <td>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_video" name="nama_video"
                                                placeholder="Masukkan Nama Video" required>
                                        </div>
                                    </div>
                        ...
                        <form id="form-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="nama_video_edit">Nama Video</label>
                                            <input type="text" class="form-control" id="nama_video_edit" name="nama_video"
                                                placeholder="Masukkan Nama Video" required>
                                        </div>
                                    </div>
            ...
            $('.btn-edit').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#kategori_video_id_edit').val(data.kategori_video_id);
                        $('#nama_video_edit').val(data.nama_video);
                        ...
                        if (data.gambar) {
                            var gambarImg = '<img src="/upload/video/' + data.gambar +
                                '" style="max-width: 200px; max-height: 200px;">';
                            var gambarLink = '<a href="/upload/video/' + data.gambar +
